...
var Module = class {
	...
	loadModule(parentscriptloader, callback) {
		...
		modulescriptloader.push_script('./js/includes/chainreader/chainreader-interface.js');

		modulescriptloader.push_script('./js/includes/chainreader/control/controllers.js');

		modulescriptloader.push_script('./js/includes/chainreader/model/ethnode.js');
		modulescriptloader.push_script('./js/includes/chainreader/model/account.js');
		modulescriptloader.push_script('./js/includes/chainreader/model/block.js');
		modulescriptloader.push_script('./js/includes/chainreader/model/contract.js');
		modulescriptloader.push_script('./js/includes/chainreader/model/transaction.js');
